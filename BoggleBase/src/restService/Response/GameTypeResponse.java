...
public class GameTypeResponse {
	...
	private final ArrayList<LetterCube> letterCubes;

	public GameTypeResponse(int gameTypeId, String name, ArrayList<LetterCube> letterCubes) {
	...
	public GameTypeResponse(GameTypeDomainObject domainObject) {
		...
		this.letterCubes = LetterCubeDomainObject.MapToResponseList(domainObject.letterCubes);
	}
	...
	public ArrayList<LetterCube> getLetterCubes() {
		return letterCubes;
	}
