...
public class S1PlayerRegistrationTest {
	...
	public void Test_CreatePlayer_DupeUsername() {
		...
		assertTrue("Incorrect Error Message provided.", message.getErrorMessage().contains("This username is already taken.") );
	}


	/*
     * "Create Player - Username is 6-12 characters", 
	...
	public void Test_CreatePlayer_UsernameSize() {
		...
		assertTrue("Incorrect Error Message provided.", message.getErrorMessage().contains("Invalid username.  The username must contain between 6 and 12 characters and must only contain English letters and numbers.") );


		//Setup Part 2 of the test.		
		username = "UserNameMoreThanTwelve";
		password = "password";
		request = new RegisterPlayerRequest(username, password);
		message = new Message();
	...
	/*
     * "Create Player - Password is 6-12 characters", 
	...
	public void Test_CreatePlayer_PasswordSize() {
		...
		assertTrue("Incorrect Error Message provided.", message.getErrorMessage().contains("Invalid password.  The password must contain between 6 and 12 characters and must only contain English letters and numbers.") );
